  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: FutureBuilder<RemoteState>(
        future: pokemonService.fetchPokemonDetail(widget.pokemonId), 
        builder: (context, snapshot) {
          return switch (snapshot.data){
            RemoteStateLoading() =>
              _PokemonDetailLoading(pokemonId: widget.pokemonId),
            RemoteStateError(error: var error) => Center(
              child: Text("Error loading pokemons: $error"),
            ),
            RemoteStateSuccess<PokemonDetailResponse>(data:var data) =>
              _PokemonDetailBody(pokemon: data),
