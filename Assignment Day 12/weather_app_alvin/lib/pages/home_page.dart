...
class _MyHomePageState extends State<MyHomePage> {
  ...
  BoxedIcon _getIconByCondition(String kondisi) {
    switch (kondisi.toLowerCase()) {
      case 'berawan':
        return BoxedIcon(WeatherIcons.cloud, color: customTheme.colorScheme.primary, size: 160);
      case 'panas':
        return BoxedIcon(WeatherIcons.day_sunny, color: customTheme.colorScheme.secondary, size: 160);
      case 'hujan':
        return BoxedIcon(WeatherIcons.rain, color: customTheme.colorScheme.tertiary, size: 160);
      case 'berangin':
            ...
            child: Column(
              ...
              children: [
                if (weatherList.isNotEmpty && currentIndex < weatherList.length) ...[
                  _getIconByCondition(weatherList[currentIndex].kondisi),
